<div class="c-content-box c-size-md strips left-image-strip">
    <div class="container">
        <div class="row">
            <div class="col-md-7 wow animate fadeInLeft">
                <div class="c-content-media-2-slider" data-slider="owl">
                    <div class="owl-theme c-theme owl-single" data-single-item="true"
                        ...
                        <div class="item">
                            <div class="c-content-media-2 c-bg-img-center"
                                style="background-image: url($Background.URL); min-height: 360px;">
                            </div>
                        </div>
                    </div>
                </div>
