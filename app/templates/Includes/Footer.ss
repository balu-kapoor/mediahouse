        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-6 c-col">
                    <p class="c-copyright c-font-grey c-font-lowercase">
                        &copy; $Year $SiteConfig.Title
                        <span class="c-font-grey-3">All Rights Reserved.</span>
                        <% loop $Menu(1) %> <% if $ClassName.ShortName == 'Page'
                        && $URLSegment != 'get-started' || $ClassName.ShortName
                        == 'HomePage' %>
                        <a href="$Link">$MenuTitle</a> <% if not $last %> / <%
